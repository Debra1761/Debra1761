...
<h4 align="center">I am a seasoned data analytics engineer with a specialized master's degree in Big Data and Machine Learning. Along with this, I am a Data Analysis enthusiast by profession with three years of enriching experience in data crunching, transforming, and cleaning. My multifaceted background enables me to view challenges from various perspectives, ensuring an innovative approach to problem-solving in the dynamic field of data. From analysis to dashboarding to exploratory data analysis using Python. I design architectures that connect various systems in the cloud and build chatbots are instant data alerts </h4>
...
- 🧰 Tools that I am more than comfortable working with: GCP | BigQuery + Airbyte + Dagster for orchestrated data magic
...
- 🤖 Vibe Coding → Following intuitive, creative flows with AI tools

- 🏗 I love building side projects that are outside my areas of expertise. SpeechCraft.io → AI that listens, analyzes, and gives real-time speech feedback. Scraping + Aggregation → Berlin news, GPS-based platforms, and experimental data mashups, which will be coming soon on hyperlokal.news/berlin
  
- 👯 I’m looking to collaborate on **OpenAI projects**

- 📫 How to reach me: **dmenezes16@gmail.com**

- ⚡ What I like to do: **I like to hike, bike(mountain biking), explore the wonders of the universe, diving, and meditation to attain a flow state ...and gaming of course**
Wanna play, find me aka **brutalbunny** on League of Legends 🃏 or beat my personal best on dirt rally 🏎.
